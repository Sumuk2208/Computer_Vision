...
from dataset_info import get_dataloader
...
def train_single_epoch(
    ...
    for im, label in tqdm(train_data, desc="training loop", position=1, leave=False):
    ...
    # Log epoch averages
    if writer is not None:
        writer.add_scalar("loss/train_epoch", epoch_loss, step)
        writer.add_scalar("acc/train_epoch", epoch_acc, step)
